...
const RecordingItem = (param)=>{
    let { recording, isPlaying, onPlay, onDelete } = param;
...
const RecordingsList = (param)=>{
    let { recordings, currentlyPlaying, onPlay, onDelete, onExtract } = param;
...
_s(useRecording, "BaMWqllJZ0MiGPIF2aVHbqBpdLI=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function Home() {
    ...
    const { isRecording, recordings, recordHint, currentlyPlaying, toggleRecording, playRecording, deleteRecording } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useRecording$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRecording"])();
...
_s(Home, "YRaG2R6va3U3wu/LaaMDEJljKBw=", false, function() {
    return [
